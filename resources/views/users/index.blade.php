...
model.masterModel = {
	...
	SELECTFILTERVALUE: [{ name: 'NAME', value: 'name'},{name: 'USERNAME', value: 'username'}],
}
var material = {
	url_dir: ko.observable('/users'),  /* location of Controller file */
									...
									<div class="row" data-bind="with:Recordmaterial" >
										...
										<div class="col-md-6 col-12">
											<div class="form-group">
												...
												<input type="text" name="txtusername" data-bind="value: username" id="" required="" class="form-control">
											</div>
										</div>
										...
										<div class="col-md-6 col-12">
											<div class="form-group">
												...
												<input type="text" name="txtpassword" data-bind="value: password" id="" required="" class="form-control">
											</div>
										</div>
