...
model.masterModel = {
	...
	SELECTFILTERVALUE: [{ name: 'reference_no', value: 'reference_no'},{name: 'payment_amount', value: 'payment_amount'}],
}
var material = {
	url_dir: ko.observable('/transaction'),  /* location of Controller file */
	Recordmaterial: ko.mapping.fromJS(model.masterModel),
	Listmaterial: ko.observableArray([]),
	Mode: ko.observable(''),
	CREATEBY: ko.observable('CREATEBY'),
	FilterText: ko.observable(""),
	DataFilter: ko.observableArray(['reference_no']),
	FilterValue: ko.observable("reference_no"),
}
				...
				<div class="card-body" data-bind="with:material">
					...
					<ul class="nav nav-tabs customtab" id="tabnavform" role="tablist">
						<li class="nav-item" role="presentation">
							<button class="nav-link active" id="form-tab" data-bs-toggle="tab" data-bs-target="#tabform" type="button" role="tab" aria-controls="home" aria-selected="true">Home</button>
						</li>
						<li class="nav-item" role="presentation">
							<button class="nav-link" id="listdata-tab" data-bs-toggle="tab" data-bs-target="#tablist" type="button" role="tab" aria-controls="profile" aria-selected="false">Profile</button>
						</li>
					</ul>
								...
								<div class="form-body">
									<div class="row" data-bind="with:Recordmaterial" >
										...
										<div class="col-md-6 col-12">
											<div class="form-group">
												<label for="first-name-vertical">reference_no</label>
												<input type="text" name="txtreference_no" data-bind="value: reference_no" id="" required="" class="form-control">
											</div>
										</div>
										...
										<div class="col-md-6 col-12">
											<div class="form-group">
												...
												<input type="text" name="txtquantity" data-bind="value: quantity" id="" required="" class="form-control">
											</div>
										</div>

										<div class="col-md-6 col-12">
											<div class="form-group">
												<label for="first-name-vertical">payment_amount</label>
												<input type="text" name="txtpayment_amount" data-bind="value: payment_amount" id="" required="" class="form-control">
											</div>
										</div>

										<div class="col-md-6 col-12">
											<div class="form-group">
												<label for="first-name-vertical">product_id</label>
												<input type="text" name="txtproduct_id" data-bind="value: product_id" id="" required="" class="form-control">
											</div>
										</div>
